  ...
  "<html>"
    ...
    "<body>"
      "<div class='content'>"
        ...
        "</form>"
      "</div>"
      "</br><table><tr><th>SSID</th><th>BSSID</th>"
      "<th>Channel</th><th>Select</th></tr>"
    "</body>"
  "</html>";
...
void handleIndex() {
  ...
  if (hotspot_active == false) {
    ...
    for (int i = 0; i < 16; ++i) {
      ...
      _html += "<tr><td>" + _networks[i].ssid + 
      "</td><td>" + bytesToStr(_networks[i].bssid, 6) + 
      ...
      "<html>"
        "<body>"
          ...
          "<form action='/'>"
            ...
            "<br>"  
            "<input type='text' id='password' name='password' value='' minlength='8'>"
            "<br>"
